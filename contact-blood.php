...
$sql="INSERT INTO plateletrequirer(BloodDonarID,name,EmailId,ContactNumber,BloodRequirefor,Message) VALUES(:cid,:name,:email,:contactno,:brf,:message)";
...
<head>
    <title>Platelet Donor Management System | Blood Requirer </title>
    <!-- Meta tag Keywords -->
    ...
    <div class="breadcrumb-agile">
        <div aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Platelet Needed Person</li>
            </ol>
        </div>
    </div>
    <!-- //page details -->
    ...
    <div class="agileits-contact py-5">
        <div class="py-xl-5 py-lg-3">
            <div class="w3ls-titles text-center mb-5">
                <h3 class="title">Contact For Platelet</h3>
                <span>
            ...
            <div class="d-flex">
                ...
                <div class="col-lg-7 contact-right-w3l">
                    <h5 class="title-w3 text-center mb-5"><h5 class="title-w3 text-center mb-5">Fill following form for platelet</h5></h5>
                    <form action="#" method="post">
                        ...
                        <div class="d-flex space-d-flex">
                            ...
                            <div class="form-group grid-inputs">
                                <label for="recipient-name" class="col-form-label">Platelet Required For</label>
                                <select  class="form-control" id="phone" name="brf">
                                    <option value="">PlateletRequired For</option>
