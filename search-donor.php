...
<head>
	<title>Platelet Donor Management System | Search Platelet Donor </title>
	<!-- Meta tag Keywords -->
	...
	<div class="breadcrumb-agile">
		<div aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Platelet Donor List</li>
			</ol>
		</div>
	</div>
	<!-- //page details -->
...
$sql = "SELECT * from plateletsdonars where (status=:status and BloodGroup=:bloodgroup) ||  (Address=:location)";
$query = $dbh -> prepare($sql);
...
{ ?>
			...
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">Search Platelet Donor</h3>
				<span>
