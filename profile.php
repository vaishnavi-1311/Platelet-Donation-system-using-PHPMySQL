...
if (strlen($_SESSION['bbdmsdid']==0)) {
 ...
 if(isset($_POST['update']))
  ...
  $sql="update plateletdonars set FullName=:name,MobileNumber=:mno, Age=:age,Gender=:gender,BloodGroup=:bloodgroup,Address=:address,Message=:message  where id=:uid";
...
<head>
	<title>Platelet Donor Management System-Donor Profile</title>
		...
		<div class="py-xl-5 py-lg-3">
			...
			<div class="d-flex">
				...
				<div class="contact-right-w3l appoint-form">
					<h5 class="title-w3 text-center mb-5">Profile Details</h5>
					<form action="#" method="post">
						<?php
$uid=$_SESSION['bbdmsdid'];
$sql="SELECT * from  plateletdonars where id=:uid";
$query = $dbh -> prepare($sql);
$query->bindParam(':uid',$uid,PDO::PARAM_STR);
$query->execute();
