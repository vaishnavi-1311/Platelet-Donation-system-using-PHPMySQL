...
$sdata=$_POST['searchdata'];
  ...
  <h4 align="center">Result against "<?php echo $sdata;?>" keyword </h4>
						...
						<div class="panel panel-default">
							<div class="panel-heading">Platelet Info</div>
							<div class="panel-body">
...
$sql="SELECT plateletrequirer.BloodDonarID,plateletrequirer.name,plateletrequirer.EmailId,plateletrequirer.ContactNumber,plateletrequirer.BloodRequirefor,plateletrequirer.Message,plateletrequirer.ApplyDate,plateletdonars.id as donid,plateletdonars.FullName,plateletdonars.MobileNumber from  plateletrequirer join plateletdonars on plateletdonars.id=plateletrequirer.BloodDonarID where plateletdonars.FullName like '%$sdata%' || plateletdonars.MobileNumber like '%$sdata%' || plateletrequirer.name like '%$sdata%' || plateletrequirer.ContactNumber like '%$sdata%'";
