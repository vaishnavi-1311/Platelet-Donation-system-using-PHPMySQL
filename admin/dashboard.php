...
<head>
	...
	<title>PLATELET DONATION & MANAGEMENT| Admin Dashboard</title>
...
<?php 
$sql ="SELECT id from plateletgroup ";
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php 
$sql1 ="SELECT id from platetdonars ";
			...
			<div class="col-md-4">
										<div class="panel panel-danger">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
												<?php 
$sql6 ="SELECT ID  from plateletrequirer ";
$query6 = $dbh -> prepare($sql6);;
$query6->execute();
$results6=$query6->fetchAll(PDO::FETCH_OBJ);
...
?>
													...
													<div class="stat-panel-title text-uppercase">Request Received</div>
												</div>
											</div>
