...
$status=1;
$sql="INSERT INTO plateletdonars(FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,Message,status) VALUES(:fullname,:mobile,:email,:age,:gender,:blodgroup,:address,:message,:status)";
...
<head>
	...
	<title>Platelet donation management system||Admin Add Donor</title>
