...
<li><a href="manage-bloodgroup.php">Manage Blood Group</a></li>
			...
			<li><a href="blood-requests.php"><i class="fa fa-users"></i> Platelet Requests</a></li>
<li><a href="request-received-bydonar.php"><i class="fa fa-search"></i>Search Platelet Request</a></li>
