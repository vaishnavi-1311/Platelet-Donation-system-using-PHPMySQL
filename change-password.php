...
$sql ="SELECT ID FROM plateletdonars WHERE id=:uid and Password=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update plateletdonars set Password=:newpassword where id=:uid";
...
<head>
	<title>Platelet Donor Management System-Change Password</title>
