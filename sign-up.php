...
$status=1;
    ...
    $ret="select EmailId from plateletdonars where EmailId=:email";
...
if($query -> rowCount() == 0)
{
$sql="INSERT INTO  plateletdonars(FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,Address,Message,status,Password) VALUES(:fullname,:mobile,:email,:age,:gender,:blodgroup,:address,:message,:status,:password)";
...
<?php $sql = "SELECT * from  plateletgroup ";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
